      ...
      <div class="screen-padding">
        ...
        <div id="help-reit-panel" style="display:none;">
          ...
          <div id="reit-compare-panel" style="display:none;">
            ...
            <div class="muted" style="font-size:11px;">* Capital appreciation figures assume REIT ~3.5% p.a. price growth, InvIT ~1.5% p.a. Green = better value on that row. FD capital stays ₹1L — no growth. DICGC insurance covers up to ₹5L per bank.</div>
          </div>
          ...
          <div id="reit-tax-panel" style="display:none;">
            ...
            <div class="muted" style="font-size:11px;">Each quarterly distribution is split into components (dividend / interest / return of capital) declared by the trust. Check the distribution notice to know the exact breakdown for tax filing.</div>
          </div>
