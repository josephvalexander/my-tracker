  ...
  async afterRender() {
    ...
    function buildReitPanel() {
      ...
      const compareSection = '<div class="section-label collapsible-header" id="reit-compare-header" style="cursor:pointer;display:flex;justify-content:space-between;">₹1L investment comparison <span class="muted" style="font-size:11px;" id="reit-compare-chev">▶ expand</span></div>'
        ...
        + '<tr style="background:var(--color-border);"><th style="padding:8px 10px;text-align:left;font-weight:600;color:var(--color-text);border-bottom:1px solid var(--color-border);width:38%;">Factor</th>'
      ...
      const taxSection = '<div class="section-label collapsible-header" id="reit-tax-header" style="cursor:pointer;display:flex;justify-content:space-between;">Taxation <span class="muted" style="font-size:11px;" id="reit-tax-chev">▶ expand</span></div>'
        ...
        + '<th style="padding:8px 10px;text-align:left;font-weight:600;color:var(--color-text);border-bottom:1px solid var(--color-border);">Component</th>'
        + '<th style="padding:8px 8px;text-align:left;font-weight:600;color:var(--color-text);border-bottom:1px solid var(--color-border);">REIT</th>'
        + '<th style="padding:8px 8px;text-align:left;font-weight:600;color:var(--color-text);border-bottom:1px solid var(--color-border);">InvIT</th>'
        + '<th style="padding:8px 8px;text-align:left;font-weight:600;color:var(--color-text);border-bottom:1px solid var(--color-border);">Note</th>'
